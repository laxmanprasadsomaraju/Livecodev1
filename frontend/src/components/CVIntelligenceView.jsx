              ...
              <div className="space-y-4">
                {isGeneratingAIView ? (
                  <div className="glass-light rounded-xl p-12 text-center">
                    ...
                    <p className="text-white mb-2">Analyzing and enhancing your CV...</p>
                  ...
                  <>
                    ...
                    <div className="glass-light rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <h3 className="text-white font-semibold">CV Comparison Analysis</h3>
                          <div className="flex items-center gap-2 text-sm">
                            <div className="flex items-center gap-1 px-2 py-1 rounded bg-red-500/20">
                              <div className="w-3 h-3 bg-red-400 rounded"></div>
                              <span className="text-red-300">Removed/Changed</span>
                            </div>
                            <div className="flex items-center gap-1 px-2 py-1 rounded bg-green-500/20">
                              <div className="w-3 h-3 bg-green-400 rounded"></div>
                              <span className="text-green-300">Enhanced/Added</span>
                            </div>
                          </div>
                        </div>
                        <Button
                          onClick={async () => {
                            setAiImprovedCV(null);
                            setIsGeneratingAIView(true);
                            try {
                              const response = await fetch(`${BACKEND_URL}/api/cv/ai-improve`, {
                                method: 'POST',
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      {/* LEFT: Original CV with Change Highlights */}
                      <div className="glass-light rounded-xl overflow-hidden">
                        <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 p-4 border-b border-white/10">
                          <div className="flex items-center gap-2">
                            <FileText className="w-5 h-5 text-orange-400" />
                            <div>
                              <h3 className="text-white font-semibold">Your Original CV</h3>
                              <p className="text-white/50 text-xs">Changes highlighted in red</p>
                            </div>
                          </div>
                        </div>
                        
                        <div className="p-6 max-h-[900px] overflow-y-auto bg-gradient-to-br from-slate-900 to-slate-800">
                          {/* Paper-like document */}
                          <div className="bg-white rounded-lg shadow-2xl p-10 min-h-[800px]">
                            <div 
                              className="text-gray-900 text-sm leading-7"
                              style={{
                                fontFamily: 'Times New Roman, serif',
                                wordWrap: 'break-word',
                                whiteSpace: 'pre-wrap'
                          ...
                          <div className="mt-4 p-3 rounded-lg bg-orange-500/10 border border-orange-500/20">
                            <p className="text-orange-300 text-xs">
                              <strong>Note:</strong> This is your original content. The AI version shows improvements with better structure, action verbs, and metrics.
                            </p>
                          </div>
                        </div>
                      </div>

                      {/* RIGHT: AI-Enhanced CV with Improvements */}
                      <div className="glass-light rounded-xl overflow-hidden">
                        <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 p-4 border-b border-white/10">
                          <div className="flex items-center gap-2">
                            <Sparkles className="w-5 h-5 text-green-400" />
                            <div>
                              <h3 className="text-white font-semibold">AI-Enhanced Version</h3>
                              <p className="text-white/50 text-xs">Professional improvements applied</p>
                            </div>
                          </div>
                        </div>
                        
                        <div className="p-6 max-h-[900px] overflow-y-auto bg-gradient-to-br from-slate-900 to-slate-800">
                          {/* Enhanced paper-like document */}
                          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg shadow-2xl p-10 min-h-[800px] border-2 border-green-500/30">
                            <div 
                              className="text-gray-900 text-sm leading-7"
                              style={{
                                fontFamily: 'Times New Roman, serif',
                            ...
                            >
                              {aiImprovedCV ? aiImprovedCV.split('\n').map((line, idx) => (
                                <div key={idx} className="mb-1">
                                  {line || '\u00A0'}
                                </div>
                              ...
                              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                      <p className="text-white/90 text-xs font-medium">Enhanced with Action Verbs</p>
                                      <p className="text-white/60 text-xs">Replaced passive language with strong action verbs (e.g., "Led", "Developed", "Optimized")</p>
                                    </div>
                                  </div>
                                  <div className="flex items-start gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                                    <div>
                                      <p className="text-white/90 text-xs font-medium">Added Quantifiable Metrics</p>
                                      <p className="text-white/60 text-xs">Included numbers and percentages to demonstrate impact</p>
                                    </div>
                                  </div>
                                  <div className="flex items-start gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                                    <div>
                                      <p className="text-white/90 text-xs font-medium">Improved Structure & Formatting</p>
                                      <p className="text-white/60 text-xs">Better organization and professional layout</p>
                                    </div>
                                  </div>
                                  <div className="flex items-start gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                                    <div>
                                      <p className="text-white/90 text-xs font-medium">ATS Optimization</p>
                                      <p className="text-white/60 text-xs">Formatted for Applicant Tracking Systems with proper keywords</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
