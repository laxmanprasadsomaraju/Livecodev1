    ...
    <div className="max-w-[1800px] mx-auto">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {generatedCode && (
                    <button
                      ...
                      className="px-3 py-2 rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 
                               hover:from-purple-400 hover:to-indigo-500 disabled:opacity-50 
                               disabled:cursor-not-allowed transition-all flex items-center gap-2 text-sm font-medium"
      ...
      {showStudioPreview && studioUrl && (
        <div className="fixed inset-0 z-50 bg-black/90 flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/10 bg-gradient-to-r from-purple-900/50 to-indigo-900/50">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="px-4 py-2 rounded-lg bg-purple-500/30 hover:bg-purple-500/50 border border-purple-500/50 transition-all flex items-center gap-2 text-sm text-purple-200"
              >
          ...
          {/* Info message about opening in new tab */}
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center p-8 max-w-lg">
              <div className="w-20 h-20 rounded-full bg-purple-500/20 flex items-center justify-center mx-auto mb-6">
                <Monitor className="w-10 h-10 text-purple-400" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Remotion Studio Ready!</h3>
              <p className="text-white/60 mb-6">
                Your video preview environment is set up and running. For the best experience with 
                Remotion Studio's interactive features, open it in a new browser tab.
              </p>
              <div className="flex gap-4 justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-3 rounded-xl bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-400 hover:to-indigo-500 transition-all flex items-center gap-2 text-white font-medium"
                >
